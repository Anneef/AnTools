...
Window Graph5() : Graph
	...
	Display /W=(611.4,39.8,1014,325.4) cSP0[*][1] vs cSP0[*][0] as "soma phaseplots"
	AppendToGraph cSP1[*][1] vs cSP1[*][0]
	AppendToGraph cSP2[*][1] vs cSP2[*][0]
	AppendToGraph cSP3[*][1] vs cSP3[*][0]
	AppendToGraph cSP4[*][1] vs cSP4[*][0]
	AppendToGraph cSP5[*][1] vs cSP5[*][0]
	AppendToGraph cSP6[*][1] vs cSP6[*][0]
	AppendToGraph cSP7[*][1] vs cSP7[*][0]
	AppendToGraph cSP8[*][1] vs cSP8[*][0]
	AppendToGraph cSP9[*][1] vs cSP9[*][0]
	AppendToGraph cSP10[*][1] vs cSP10[*][0]
	AppendToGraph cSP11[*][1] vs cSP11[*][0]
	AppendToGraph cSP12[*][1] vs cSP12[*][0]
	AppendToGraph cSP13[*][1] vs cSP13[*][0]
	AppendToGraph cSP14[*][1] vs cSP14[*][0]
	AppendToGraph cSP15[*][1] vs cSP15[*][0]
	AppendToGraph zentral[*][1] vs zentral[*][0]
	AppendToGraph zentral_opt[*][1] vs zentral_opt[*][0]
	ModifyGraph margin(right)=85
	ModifyGraph lSize(zentral)=2
	ModifyGraph rgb(cSP0)=(49931,65535,0,52428),rgb(cSP1)=(15603,65535,0,52428),rgb(cSP2)=(43690,65535,0,52428)
	ModifyGraph rgb(cSP3)=(21845,65535,0,52428),rgb(cSP4)=(65535,59293,0,52428),rgb(cSP5)=(28086,65535,0,52428)
	ModifyGraph rgb(cSP6)=(32767,0,65535,52428),rgb(cSP7)=(40569,65535,0,52428),rgb(cSP8)=(59293,65535,0,52428)
	ModifyGraph rgb(cSP9)=(65535,62414,0,52428),rgb(cSP10)=(65535,46810,0,52428),rgb(cSP11)=(65535,31207,0,52428)
	ModifyGraph rgb(cSP12)=(65535,37448,0,52428),rgb(cSP13)=(65535,0,0,52428),rgb(cSP14)=(65535,53052,0,52428)
	ModifyGraph rgb(cSP15)=(65535,62414,0,52428),rgb(zentral)=(0,0,0),rgb(zentral_opt)=(43690,43690,43690)
	ModifyGraph plusRGB(cSP0)=(65535,0,0,32768),plusRGB(cSP1)=(65535,0,0,32768),plusRGB(cSP2)=(65535,0,0,32768)
	ModifyGraph plusRGB(cSP3)=(65535,0,0,32768),plusRGB(cSP4)=(65535,0,0,32768),plusRGB(cSP5)=(65535,0,0,32768)
	ModifyGraph plusRGB(cSP6)=(65535,0,0,32768),plusRGB(cSP7)=(65535,0,0,32768),plusRGB(cSP8)=(65535,0,0,32768)
	ModifyGraph plusRGB(cSP9)=(65535,0,0,32768),plusRGB(cSP10)=(65535,0,0,32768),plusRGB(cSP11)=(65535,0,0,32768)
	ModifyGraph plusRGB(cSP12)=(65535,0,0,32768),plusRGB(cSP13)=(65535,0,0,32768),plusRGB(cSP14)=(65535,0,0,32768)
	ModifyGraph plusRGB(cSP15)=(65535,0,0,32768)
	ModifyGraph negRGB(cSP0)=(65535,0,0,32768),negRGB(cSP1)=(65535,0,0,32768),negRGB(cSP2)=(65535,0,0,32768)
	ModifyGraph negRGB(cSP3)=(65535,0,0,32768),negRGB(cSP4)=(65535,0,0,32768),negRGB(cSP5)=(65535,0,0,32768)
	ModifyGraph negRGB(cSP6)=(65535,0,0,32768),negRGB(cSP7)=(65535,0,0,32768),negRGB(cSP8)=(65535,0,0,32768)
	ModifyGraph negRGB(cSP9)=(65535,0,0,32768),negRGB(cSP10)=(65535,0,0,32768),negRGB(cSP11)=(65535,0,0,32768)
	ModifyGraph negRGB(cSP12)=(65535,0,0,32768),negRGB(cSP13)=(65535,0,0,32768),negRGB(cSP14)=(65535,0,0,32768)
	ModifyGraph negRGB(cSP15)=(65535,0,0,32768)
	ModifyGraph mrkStrokeRGB(cSP0)=(0,0,0,32768),mrkStrokeRGB(cSP1)=(0,0,0,32768),mrkStrokeRGB(cSP2)=(0,0,0,32768)
	ModifyGraph mrkStrokeRGB(cSP3)=(0,0,0,32768),mrkStrokeRGB(cSP4)=(0,0,0,32768),mrkStrokeRGB(cSP5)=(0,0,0,32768)
	ModifyGraph mrkStrokeRGB(cSP6)=(0,0,0,32768),mrkStrokeRGB(cSP7)=(0,0,0,32768),mrkStrokeRGB(cSP8)=(0,0,0,32768)
	ModifyGraph mrkStrokeRGB(cSP9)=(0,0,0,32768),mrkStrokeRGB(cSP10)=(0,0,0,32768),mrkStrokeRGB(cSP11)=(0,0,0,32768)
	ModifyGraph mrkStrokeRGB(cSP12)=(0,0,0,32768),mrkStrokeRGB(cSP13)=(0,0,0,32768),mrkStrokeRGB(cSP14)=(0,0,0,32768)
	ModifyGraph mrkStrokeRGB(cSP15)=(0,0,0,32768)
	ModifyGraph barStrokeRGB(cSP0)=(0,0,0,32768),barStrokeRGB(cSP1)=(0,0,0,32768),barStrokeRGB(cSP2)=(0,0,0,32768)
	ModifyGraph barStrokeRGB(cSP3)=(0,0,0,32768),barStrokeRGB(cSP4)=(0,0,0,32768),barStrokeRGB(cSP5)=(0,0,0,32768)
	ModifyGraph barStrokeRGB(cSP6)=(0,0,0,32768),barStrokeRGB(cSP7)=(0,0,0,32768),barStrokeRGB(cSP8)=(0,0,0,32768)
	ModifyGraph barStrokeRGB(cSP9)=(0,0,0,32768),barStrokeRGB(cSP10)=(0,0,0,32768),barStrokeRGB(cSP11)=(0,0,0,32768)
	ModifyGraph barStrokeRGB(cSP12)=(0,0,0,32768),barStrokeRGB(cSP13)=(0,0,0,32768),barStrokeRGB(cSP14)=(0,0,0,32768)
	ModifyGraph barStrokeRGB(cSP15)=(0,0,0,32768)
	ModifyGraph btLen=3
	SetAxis left -9.34529251807476,60.3623817462501
	SetAxis bottom -78.1502530626855,-41.1410241939095
	Cursor/P A cSP4 12
	ShowInfo
	ColorScale/C/N=CS/F=0/B=1/X=103.92/Y=7.32  ctab={0,10147.6171875,Rainbow,0}
	ColorScale/C/N=CS tickLen=3
	AppendText "DistFrom13"
EndMacro
